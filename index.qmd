---
title: "Design, Experiments & Causal Evidence"
subtitle: "How statistical evidence is produced — from a question and a design to a defensible claim"
toc: false
---

![](assets/hero.png){.course-hero-img fig-alt="Course identity hero for Design, Experiments and Causal Evidence — a tan desert-rose crystal cluster surrounded by study-design graphics including a design-to-evidence workflow, a causal diagram with a confounder and a backdoor path, and a blocking-improves-precision illustration, with the course title."}
